...
import com.job.jobnews.adapter.CategoryAdapter
...
import com.job.jobnews.ui.viewmodel.CategoriesViewModel
    ...
    private fun insertData(body: List<CategoryResponse>) {
        class InsertData:AsyncTask<Void,Void,Void>(){
            ...
            override fun onPostExecute(result: Void?) {
                if (categoryList.isEmpty() || categoryList == null || categoryList[0] == null) {
                    loadLocalData()
                }
